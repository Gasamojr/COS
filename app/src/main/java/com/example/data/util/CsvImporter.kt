...
object CsvImporter {
    ...
    fun parseCsv(csvContent: String): CsvImportResult {
        ...
        var clientIdx = headers.indexOfFirst { it.contains("cliente") || it.contains("nome") }
        ...
        // Fallback to position if headers match standard 5 columns
        ...
        if (!hasHeader) {
            ...
            if (issueDateIdx == -1) issueDateIdx = 3
            if (deliveryDateIdx == -1) deliveryDateIdx = 4
        }
    ...
    fun generateSampleCsv(): String {
        return """
Número da O.S.;Nome do cliente;Descrição do serviço;Data de emissão;Data de entrega
OS-2026-0148;Gráfica Amazonas;Impressão de Catálogos de Produtos (5000 un);25/07/2026;05/08/2026
OS-2026-0147;Papel & Cia Ltda;Cartazes Promocionais Couché 170g (2000 un);24/07/2026;02/08/2026
OS-2026-0146;Loja do Brinde;Folders Tri-fold Verniz Localizado (3000 un);24/07/2026;30/07/2026
OS-2026-0145;Mega Marketing;Banners Lona 440g Ilhós (15 un);23/07/2026;31/07/2026
OS-2026-0144;Editora Alvorada;Livros Capa Dura com Laminação Fosca (1000 un);22/07/2026;10/08/2026
OS-2026-0143;Restaurante Sabor;Cardápios Plastificados Polaseal (100 un);22/07/2026;28/07/2026
OS-2026-0142;Agência Criativa;Caixas Embalagem Cartão Duplex (4000 un);20/07/2026;08/08/2026
OS-2026-0141;Farmácia Saúde;Rótulos Adesivos Papel Couche (10000 un);20/07/2026;27/07/2026
        """.trimIndent()
    }
}
